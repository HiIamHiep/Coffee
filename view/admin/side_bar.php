        ...
        <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
                <div class="nav-profile-image">
                    <img src="<?php if(!empty($_SESSION['photo'])) { echo $_SESSION['photo']; } ?>" alt="profile">
                    <span class="login-status online"></span>
                    <!--change to offline or busy as needed-->
                </div>
                <div class="nav-profile-text d-flex flex-column">
                    <span class="font-weight-bold mb-2"><?php if (!empty($_SESSION['name'])) {
                            echo $_SESSION['name'];
                        } ?></span>
                    <span class="text-secondary text-small"><?php if (!empty($_SESSION['role'])) {
...
<!--                                            href="./view/admin/pages/ui-features/buttons.html">Buttons</a>-->
<!--                    </li>-->
<!--                    <li class="nav-item"><a class="nav-link"-->
...
<!--        </li>-->
        ...
        <li class="nav-item">
            <a class="nav-link" href="?controller=admin&action=manufacturer">
                <span class="menu-title">Manufacturers</span>
                <i class="fa-solid fa-industry menu-icon"></i>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="?controller=admin&action=products">
